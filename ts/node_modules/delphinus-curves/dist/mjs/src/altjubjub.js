...
export class CurveField {
    v;
    get modulus() {
        return new BN("2736030358979909402780800718157159386076813972158567259200215660948447373041", 10);
    }
    constructor(v) {
        if (!(v instanceof BN)) {
            v = new BN(v);
...
const constants = {
    c: new Field(0),
    a: new Field(new BN("21888242871839275222246405745257275088548364400416034343698204186575808495616", 10)),
    d: new Field(new BN("12181644023421730124874158521699555681764249180949974110617291017600649128846", 10)),
    gX: new Field(new BN("21237458262955047976410108958495203094252581401952870797780751629344472264183", 10)),
    gY: new Field(new BN("2544379904535866821506503524998632645451772693132171985463128613946158519479", 10)),
};
export class Point {
    x;
    y;
