...
import { submitProofWithRetry, get_latest_proof } from "./prover.js";
...
async function install_transactions(tx, jobid) {
...
async function track_error_transactions(tx, jobid) {
